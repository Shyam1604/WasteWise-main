...
export default function ProfileScreen({ navigation }) {
  ...
  const [profileData, setProfileData] = useState({
    profileImage: 'https://img.freepik.com/free-vector/user-blue-gradient_78370-4692.jpg?t=st=1737736719~exp=1737740319~hmac=940a6e2731bcb9860ac8907cbaf282ec2bdc1d0730f37d1e814653d6ebc17cac&w=740', // default image
    username: 'Guest',
    bio: 'Change me',
  });
